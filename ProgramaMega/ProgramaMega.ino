...
#define BTN_SEMAFORO1 22
#define BTN_SEMAFORO2 23
#define BTN_SEMAFORO3 24
#define BTN_SEMAFORO4 25
...
void setup() {
  ...
  pinMode(BTN_SEMAFORO1, INPUT_PULLUP);  
  pinMode(BTN_SEMAFORO2, INPUT_PULLUP);  
  pinMode(BTN_SEMAFORO3, INPUT_PULLUP);  
  pinMode(BTN_SEMAFORO4, INPUT_PULLUP);  
